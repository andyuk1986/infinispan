...
However, when some operations are processed successfully, they return an HTTP ssdsdtatus code such as `204` or `202` instead of `200`.
====

[id='rest_v2_cache_operations']
== Creating and Managing Cachessdssdfsdsdsdsdsdfdadsasdfsdsssdf
Create and manage {brandname} caches and perform operations on data hi asahi hi.
...
//Community content
ifdef::community[]
See link:../xsite/xsite.html[Cross Site replication] for more details about this feature.sdsds dsfsdfs
endif::community[]
